"""
Django settings for poke_fav project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'poke_fav.contexts.appname'
            ],
        },
    },
]

WSGI_APPLICATION = 'poke_fav.wsgi.application'
...
try:
    ...
    print("Missing database configuration in local_settings.py!")
